...
charset_comment_filter_hu = require("charset_comment_filter_hu") --Unicode分区提示
core2022 = require("core2022_filter") --自定义字符集过滤（常用字集）
-- dz_ci = require("dz_ci_filter") --单字模式 这个别用，有问题的
number_translator_hu = require("number_hu")
...
shijian2_translator_hu = require("shijian2_hu") -- 高级时间